...
module.exports = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    // a new module in demo.js causes a new vendor.js bundle to be emitted even if no
    // vendor code has changed, and vice versa. Note that this slightly increases the
